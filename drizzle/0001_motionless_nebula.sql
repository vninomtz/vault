...
ALTER TABLE `files` ADD `account_id` text(26) NOT NULL DEFAULT '01SYSTEM000000000000000000';--> statement-breakpoint
...
ALTER TABLE `authors` ADD `account_id` text(26);--> statement-breakpoint
CREATE INDEX `idx_authors_account_id` ON `authors` (`account_id`);--> statement-breakpoint
UPDATE `authors` SET `account_id` = '01SYSTEM000000000000000000' WHERE `id` = '01SYSTEM000000000000000001';--> statement-breakpoint
ALTER TABLE `tokens` ADD `account_id` text(26) NOT NULL DEFAULT '01SYSTEM000000000000000000';--> statement-breakpoint
