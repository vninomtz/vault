...
ALTER TABLE `files` ADD `account_id` text(26) NOT NULL DEFAULT '01SYSTEM000000000000000000' REFERENCES accounts(id);--> statement-breakpoint
...
ALTER TABLE `tokens` ADD `account_id` text(26) NOT NULL DEFAULT '01SYSTEM000000000000000000' REFERENCES accounts(id);--> statement-breakpoint
